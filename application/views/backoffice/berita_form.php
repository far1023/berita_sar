							...
							<div class="card">
								...
								<div class="card-body text-sm">
									...
									<div class="input-group">
										<input type="text" class="form-control form-control-sm form-min" placeholder="Judul Berita" name="judul" value="<?= set_value('judul') ?>">
									</div>
											...
											<?php foreach ($tags as $vtag): ?>
												<div class="col-sm-3 col-6">
													<div class="icheck-red">
														<input type="checkbox" id="tags<?= $i ?>" name="tags[]" value="<?= $vtag->id_tag ?>">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-3 col-6"><div class="icheck-red">
													<input type="checkbox" id="user2" name="user[]" value="1">
													<label for="user2" style="font-weight: normal !important;">
														Dosen
													</label>
											</div></div>
											<div class="col-sm-3 col-6"><div class="icheck-red">
													<input type="checkbox" id="user3" name="user[]" value="2">
													<label for="user3" style="font-weight: normal !important;">
														Mahasiswa
													</label>
											</div></div>
											<div class="col-sm-3 col-6"><div class="icheck-red">
													<input type="checkbox" id="user4" name="user[]" value="3">
									...
									<div class="input-group">
										<textarea name="isi" id="isi" class="textarea"><?= set_value('isi') ?></textarea>
									</div>
									<div class="input-group">
